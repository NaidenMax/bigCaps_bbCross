...
2. Pre-extracts numpy arrays for OHLC + indicators and `searchsorted` index lookups for daily / 5-min dates -- the inner loop is vectorised, not pandas-row-iterated.
